...
const HomeDesktop = ({ roleId }) => {
  ...
  useEffect(() => {
    ...
    const roleActions = {
      1: [fetchAbsences, fetchPayroll, fetchApprovedByPA, fetchLocation, fetchEmployees, fetchSuratDinas],
  ...
  <div
    onClick={onClick}
    className="flex items-center justify-between p-6 bg-white rounded-2xl shadow-sm border border-gray-100 transition-all duration-300 cursor-pointer group hover:shadow-lg hover:ring-2 hover:ring-green-300/30"
  >
