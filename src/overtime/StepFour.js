...
const StepFour = ({ formData, handleNextStepData }) => {
  const { form, nama, tugas, divisi, lokasi, id_nama, id_lembur, jamMasuk, id_lokasi, jamPulang, titikKoordinatMasuk, titikKoordinatPulang } = formData;
