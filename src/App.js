...
const App = () => {
  ...
  const routes = [
    ...
    { path: "/kadiv-member", component: <KadivMember />, roles: ["1", "4", "6"], layout: SidebarLayout },
    { path: "/kadiv-member/show/:id_user", component: <DetailKadivMember />, roles: ["1", "4", "6"], layout: SidebarLayout },
