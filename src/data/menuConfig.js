...
export const menuConfig = [
    ...
    // ABSENSI & KEHADIRAN
    {
        ...
        items: [
            { label: "Form Absensi", icon: faCalendarCheck, path: "/absensi", roles: [5,20] },
            {
                label: "Kelola Absensi", icon: faUserEdit, roles: [1,4,5,6,18],
                submenu: [
    ...
    // LEMBUR & DINAS
    {
        sectionTitle: "Lembur & Dinas",
        items: [
            { label: "Formulir Lembur", icon: faClock, path: "/lembur", roles: [5,20] },
            { label: "Formulir Dinas", icon: faPlaneDeparture, path: "/formulir-dinas", roles: [5,20] },
            {
                label: "Pengajuan Lembur & Dinas", icon: faBusinessTime, roles: [1,4,5,6,20],
                submenu: [
    ...
    // PENGGAJIAN & TUNJANGAN
    {
        ...
        items: [
            ...
            {
                label: "Penggajian", icon: faMoneyBillWave, roles: [1,4,6],
                submenu: [
    ...
    // REMINDER
    {
        ...
        items: [
            {
                label: "NICO Reminder", icon: faTasks, roles: [1,5,20],
                submenu: [
                    { label: "Reminder", icon: faListCheck, path: "/penugasan", roles: [1,5,20] },
                    { label: "Riwayat Reminder", icon: faFolderOpen, path: "/penugasan/riwayat", roles: [1,5,20] },
                ],
            },
        ],
    },
    ...
    // MANAJEMEN SDM
    {
        ...
        items: [
            ...
            {
                label: "Manajemen Divisi", icon: faUsersCog, roles: [1,4,6],
                submenu: [
                    { label: "Kelola Divisi", icon: faUsersCog, path: "/divisi", roles: [1,4,6] },
                    { label: "Kelola Kepala Divisi", icon: faUsersCog, path: "/kadiv-member", roles: [1,4,6] },
                ],
            },
            {
                label: "Perusahaan", icon: faBuilding, roles: [1,4,6],
                submenu: [
