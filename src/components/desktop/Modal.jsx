    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-3">
            <div className={`bg-white rounded-2xl shadow-lg w-full ${sizeClass} relative`}>
                {/* Header selalu terlihat, tidak di-scroll */}
                <div className="px-4 py-3 sm:py-4 sm:px-6 bg-green-600 text-white rounded-t-2xl relative">
                    <div className="pr-10">
                ...
                {/* Body: diberi max-h + overflow agar hanya bagian ini yang bisa di-scroll */}
