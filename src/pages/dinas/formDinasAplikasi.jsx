...
export default function SuratDinasPage() {
  ...
  const handleChange = (field, value) => {
    setForm((prev) => {
      if (field === "kategori") {
        const needTanggalPulang = value?.value === 2 || value?.value === 3;
        return {
          ...prev,
          kategori: value,
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      return toast.error(
        "Tanggal pulang harus diisi dan tidak boleh sebelum tanggal berangkat.",
      );
    }
    ...
    try {
      ...
      if (!res.ok) {
        const message =
          data?.message || data?.error || "Terjadi kesalahan pada sistem.";
  ...
  return (
    <>
          ...
          <div className="bg-white rounded-xl shadow border border-gray-200 p-4 space-y-4">
            ...
            <div className="grid grid-cols-1 gap-3">
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange("tgl_berangkat", e.target.value)
                  }
                />
              </div>
              ...
              {(form.kategori?.value === 2 || form.kategori?.value === 3) && (
                <div className="space-y-1">
                  ...
                  <input
                    type="date"
                    min={form.tgl_berangkat || undefined}
                    className="w-full rounded-lg border px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500"
            ...
            <label className="flex gap-3 rounded-lg p-3 border border-green-600/20 cursor-pointer">
              ...
              <span className="text-xs leading-snug ">
                Saya menyatakan data yang saya isi{" "}
                <strong>benar, jujur, dan dapat dipertanggungjawabkan</strong>.
              </span>
            </label>
            ...
            <button
              ...
              className="w-full py-3 rounded-md bg-green-600 text-white font-semibold disabled:opacity-60 active:scale-[0.98] transition"
            >
      ...
      <Modal
        ...
        note="Harap dibaca dan dipahami sebelum mengajukan."
        size="md"
      >
        <div className="space-y-5 text-sm leading-relaxed text-gray-800">
          <p>
            Formulir ini merupakan{" "}
            <strong>permohonan resmi perjalanan dinas </strong>
            yang digunakan oleh karyawan dalam menjalankan tugas atas penugasan
            perusahaan. Seluruh data yang diinput akan menjadi dasar proses
          ...
          <div>
            ...
            <ul className="list-disc list-outside pl-5 space-y-2">
              <li>
                <strong>Area A – Jabodetabek</strong>
                <br />
                Digunakan untuk perjalanan dinas yang dilakukan
                <strong> di dalam wilayah Jabodetabek</strong>. Area ini
                merupakan kategori khusus dan
                <strong> tidak termasuk</strong> ke dalam perjalanan dinas luar
                daerah.
              </li>
              <li>
                <strong>Area B – Jawa &amp; Bali (Non-Jabodetabek)</strong>
                <br />
                Digunakan untuk perjalanan dinas yang dilakukan
                <strong> di luar wilayah Jabodetabek</strong>, namun masih
                berada <strong>di Pulau Jawa atau Pulau Bali</strong>.
                Perjalanan pada kategori ini umumnya memerlukan
                <strong> pengisian tanggal berangkat dan tanggal pulang</strong>
                .
              </li>
              <li>
                <strong>Area C – Luar Jawa &amp; Bali</strong>
                <br />
                Digunakan untuk perjalanan dinas yang dilakukan
                <strong> di luar Pulau Jawa dan Pulau Bali</strong>, termasuk
          ...
          <div>
            <h3 className="font-semibold mb-2 text-gray-900">Ketentuan Umum</h3>
            <ul className="list-disc list-outside pl-5 space-y-2">
              <li>
                Pengajuan perjalanan dinas{" "}
                <strong>wajib dilakukan sebelum keberangkatan</strong>.
              </li>
              <li>
                Kategori perjalanan harus dipilih{" "}
                <strong>sesuai dengan lokasi tujuan sebenarnya</strong>.
              </li>
              <li>
                Untuk perjalanan dinas di luar wilayah Jabodetabek, tanggal
                berangkat dan pulang harus diisi
          ...
          <div>
            ...
            <ul className="list-disc list-outside pl-5 space-y-2">
              <li>
                Ketidaksesuaian antara data yang diinput dengan kondisi
                sebenarnya dapat menyebabkan{" "}
                <strong>penolakan pengajuan</strong>.
              </li>
              <li>
