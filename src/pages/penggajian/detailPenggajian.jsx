            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-2">
                ...
                <div
                  className={`px-3 py-2 rounded-lg bg-blue-100 text-center cursor-pointer transition-all duration-300 
                    ${activeTab === "absen" ? "border-2 border-blue-500 shadow-sm shadow-blue-300" : "border border-transparent"}`}
                ...
                <div
                  className={`px-3 py-2 rounded-lg bg-yellow-100 text-center cursor-pointer transition-all duration-300 
                    ${activeTab === "lembur" ? "border-2 border-yellow-500 shadow-sm shadow-yellow-300" : "border border-transparent"}`}
    ...
    >
      ...
      <div className="flex items-center justify-center mb-4">
        ...
        <span className="text-lg font-semibold text-gray-900">
          {activeTab === "absen" ? item.tanggal_absen : item.tanggal_lembur || "Tidak Tersedia"}
        </span>
      </div>
      ...
      <div className={`grid ${activeTab === "absen" ? "grid-cols-2" : "grid-cols-3"} gap-4 bg-gray-200 rounded-xl p-3`}>
        ...
        <div className="flex flex-col items-center text-center bg-white p-2 rounded-lg shadow-md">
          ...
          <span className="text-md text-gray-700">
            {activeTab === "absen" ? item.absen_selesai || "-" : item.selesai_lembur || "-"}
          </span>
        </div>
