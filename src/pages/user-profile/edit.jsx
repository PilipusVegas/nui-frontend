          ...
          <form onSubmit={handleSubmit} className="space-y-6 max-w-md mx-auto">
            <section className="space-y-2">
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-600 mb-1 tracking-wide">
                  Masukkan nomor aktif tanpa spasi atau tanda baca (maks. 13 digit).
                </p>
                <input type="tel" name="telp" value={formData.telp || ""} onChange={(e) => {
