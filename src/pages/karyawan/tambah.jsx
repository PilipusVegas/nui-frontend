...
const TambahKaryawan = () => {
  ...
  const handleAdd = async () => {
    if (!currentUser.nip || !currentUser.nama || !currentUser.username || !currentUser.password || !currentUser.id_perusahaan || !currentUser.id_role || !currentUser.id_shift) {
    ...
    <div className="bg-white flex flex-col">
      ...
      <form onSubmit={(e) => { e.preventDefault(); handleAdd(); }} className="flex-grow py-5 px-3 w-full mx-auto space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {/* === BIODATA KARYAWAN === */}
          <div className="col-span-full flex items-center gap-4 mb-3">
