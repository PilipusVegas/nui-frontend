        ...
        <form className="w-full max-w-xl p-6 border-2 border-gray-300 rounded-lg bg-white" onSubmit={handleSubmit} ref={dropdownRef}>
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input type="text" id="lokasi" name="lokasi" autoComplete="off" value={lokasi} className={`w-full p-2 text-sm border-2 tracking-wide rounded-lg focus:outline-none ${ errorLokasi ? "border-red-500" : "border-gray-300 focus:border-blue-500"}`}
