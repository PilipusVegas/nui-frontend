  ...
  import { faSpinner, faArrowRight, faArrowAltCircleLeft, faArrowRotateBack } from "@fortawesome/free-solid-svg-icons";
  ...
  const StepTwoSelesai = ({ handleNextStepData }) => {
    ...
    const switchCamera = async () => {
      try {
        ...
        // Tambahkan delay kecil agar kamera benar-benar berhenti sebelum di-start ulang
