...
const TunjanganKaryawan = () => {
    ...
    useEffect(() => {
        ...
        if (search.trim()) {
            ...
            data = data.filter((i) => i.nama.toLowerCase().includes(lower) || i.nip.toLowerCase().includes(lower));
        }
    ...
    return (
        <div className="w-full animate-fadeIn">
            <SectionHeader title="Tunjangan Karyawan" subtitle="Kelola tunjangan karyawan berdasarkan kebijakan perusahaan" onBack={() => navigate(-1)}
                actions={
            ...
            <Modal isOpen={detailOpen} onClose={() => setDetailOpen(false)} title="Detail Tunjangan" size="lg">
            ...
            <Modal isOpen={infoOpen} onClose={() => setInfoOpen(false)} title="Informasi Tunjangan Karyawan" note="Penjelasan jenis tunjangan, arti ikon, serta ketentuan umum pemberian tunjangan karyawan." size="lg">
                <div className="space-y-4 text-sm text-gray-700 leading-relaxed">
                    ...
                    <div>
                        ...
                        <p>
                            Menu <b>Tunjangan Karyawan</b> digunakan untuk mengatur hak tunjangan yang
                            diterima setiap karyawan berdasarkan peran, kebutuhan operasional,
                        ...
                        <ul className="space-y-3 text-sm text-gray-700 leading-relaxed">
                            ...
                            <li className="flex items-start gap-2">
                                ...
                                <span>
                                    ...
                                    <ul className="list-disc pl-5 mt-1 space-y-1">
                                        <li>Karyawan <b>sudah ditandai berhak menerima tunjangan</b>.</li>
                                        <li>Melakukan <b>lembur minimal 5 jam</b>.</li>
                                        <li>Lembur dilakukan di <b>lokasi kerja lapangan (gerai)</b>.</li>
                                        <li><b>Tidak berlaku</b> untuk lokasi kantor: Kantor Palem, Utan Jati, dan Garuda.</li>
                            ...
                            <li className="flex items-start gap-2">
                                ...
                                <span>
                                    ...
                                    <ul className="list-disc pl-5 mt-1 space-y-1">
                                        <li>Karyawan <b>sudah ditandai berhak menerima tunjangan</b>.</li>
                                        <li>Melakukan <b>perjalanan dinas ke luar kota</b>.</li>
                                        <li><b>Melakukan absensi</b> pada hari perjalanan dinas tersebut.</li>
                                        <li>Jika karyawan <b>tidak masuk atau tidak absen</b>, maka tunjangan <b>dibatalkan</b>.</li>
                                        <li><b>Tidak berlaku</b> untuk hari Minggu.</li>
                                    </ul>
                                </span>
                            </li>
                            ...
                            <li className="flex items-start gap-2">
                                ...
                                <span>
                                    ...
                                    <ul className="list-disc pl-5 mt-1 space-y-1">
                                        <li>Karyawan <b>sudah ditandai berhak menerima tunjangan</b>.</li>
                                        <li>Menggunakan <b>kendaraan pribadi</b>.</li>
                                        <li>Bekerja dan melakukan absensi di <b>gerai</b>.</li>
                                        <li><b>Tidak berlaku</b> untuk lokasi kantor: Kantor Palem, Utan Jati, dan Garuda.</li>
                                        <li>Absensi dinyatakan <b>sesuai dan memenuhi syarat</b>.</li>
                                    </ul>
                                </span>
                            </li>
                            ...
                            <li className="flex items-start gap-2">
                                ...
                                <span>
                                    ...
                                    <ul className="list-disc pl-5 mt-1 space-y-1">
                                        <li>Karyawan <b>sudah ditandai berhak menerima tunjangan</b>.</li>
                                        <li>Melakukan <b>absensi shift malam</b>.</li>
                                        <li>Bekerja di <b>gerai</b>, bukan kantor.</li>
                                        <li><b>Tidak berlaku</b> untuk lokasi kantor: Kantor Palem, Utan Jati, dan Garuda.</li>
                                    </ul>
                                </span>
                            </li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-700">
                            <li className="flex items-center gap-2">
                                ...
                                <span>
                                    <b>Ikon berwarna</b> menandakan tunjangan <b>aktif</b> dan berlaku
                            ...
                            <li className="flex items-center gap-2">
                                ...
                                <span>
                                    <b>Ikon abu-abu</b> menandakan tunjangan <b>tidak aktif</b> atau
                                    tidak diberikan.
                                </span>
                            </li>
                        </ul>
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                        ...
                        <ul className="list-disc pl-5 text-blue-800 space-y-1">
                            <li>
                                Setiap karyawan hanya dapat memiliki satu konfigurasi tunjangan aktif.
                            </li>
                            <li>
                                Perubahan tunjangan akan langsung memengaruhi perhitungan hak
                                karyawan terkait.
                            </li>
                            <li>
                                Pastikan data karyawan dan kebijakan perusahaan sudah sesuai sebelum
                                menyimpan perubahan.
                            </li>
                        </ul>
                    </div>
