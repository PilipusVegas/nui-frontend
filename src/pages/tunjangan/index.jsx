      ...
      <SectionHeader title="Rekap Tunjangan Karyawan" subtitle="Menampilkan Rekap Tunjangan Perminggu Secara Otomatis dan Sistematis." onBack={() => Navigate("/")}
        actions={
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button
              onClick={() =>
                exportRekapTunjangan(
                  dataTunjangan,
                  tanggalArray,
                  user.nama_user,
                )
              }
              disabled={dataTunjangan.length === 0}
            ...
            <button
              ...
              className="flex items-center gap-2 h-9 px-3 text-sm font-medium rounded-md shadow-md bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-white transition-all duration-200"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 h-9 px-3 text-sm font-medium rounded-md shadow-md bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white transition-all duration-200"
            >
                ...
                <thead>
                  ...
                  <tr>
                    {[
                      "NIP",
                      "Nama",
                      ...TUNJANGAN_CONFIG.map((t) => t.label),
                      "Nominal",
                    ].map((header) => {
                      let widthStyle = {};
                        ...
                        {tanggalArray.map((tgl) => {
                          ...
                          return TUNJANGAN_CONFIG.map((t) => {
                            ...
                            return (
                              <td
                                key={`${tgl}-${t.key}`}
                                className={`border px-2 py-2 text-center relative transition
                                    ${!isActive ? "bg-gray-100 text-gray-400" : "hover:bg-green-50"}
                                `}
                                onMouseEnter={(e) =>
                                  data && handleMouseEnter(e, data)
                                }
          ...
          <div className="grid grid-cols-1 gap-4 text-sm text-gray-700 leading-relaxed">
            <div>
              <span className="font-bold text-green-700">
                TUM – Tunjangan Uang Makan
              </span>
              <ul className="list-disc list-inside ml-2">
                <li>
                  Diberikan jika karyawan lembur minimal <b>5 jam</b> dalam satu
                  hari.
                </li>
                <li>
                  Hanya berlaku untuk karyawan yang <b>bekerja di gerai</b>{" "}
                  (kantor tidak termasuk).
                </li>
            ...
            <div>
              <span className="font-bold text-red-600">
                TSM – Tunjangan Shift Malam
              </span>
              <ul className="list-disc list-inside ml-2">
                <li>
                  Diberikan kepada karyawan <b>shift malam di gerai</b>.
                </li>
                <li>
                  Berlaku hanya untuk divisi: <b>Teknisi Installer</b>,{" "}
                  <b>Helper</b>, <b>Supir</b>, dan <b>Operasional</b>.
                </li>
              </ul>
            </div>
            <div>
              <span className="font-bold text-indigo-700">
                TKP – Tunjangan Kendaraan Pribadi
              </span>
              <ul className="list-disc list-inside ml-2">
                <li>
                  Diberikan jika karyawan <b>menggunakan kendaraan pribadi</b>{" "}
                  saat <b>shift malam di gerai</b>.
                </li>
                <li>
                  Berlaku untuk divisi: <b>Installer</b>, <b>Helper</b>,{" "}
                  <b>Supir</b>, dan <b>Operasional</b>.
                </li>
                <li>
                  <b>Tidak diberikan</b> jika menggunakan kendaraan kantor.
                </li>
              </ul>
            </div>
            <div>
              <span className="font-bold text-blue-700">
                TDP – Tunjangan Perjalanan Dinas
              </span>
              <ul className="list-disc list-inside ml-2">
                <li>
                  Diberikan kepada karyawan yang menjalankan{" "}
                  <b>tugas dinas luar kota</b> atau perjalanan kerja sesuai
                  penugasan perusahaan.
                </li>
                <li>
                  Diperuntukkan untuk menutup kebutuhan perjalanan seperti{" "}
                  <b>transportasi, konsumsi, dan biaya terkait dinas</b>.
                </li>
                <li>
                  Berlaku untuk seluruh divisi yang menerima{" "}
                  <b>surat tugas resmi</b> atau instruksi perjalanan dari
                  atasan.
                </li>
                <li>
                  <b>Besaran tunjangan</b> menyesuaikan kebijakan perusahaan
                  berdasarkan area tujuan dan durasi perjalanan.
                </li>
                <li>
                  <b>Tidak diberikan</b> apabila perjalanan dilakukan tanpa
                  penugasan resmi atau bersifat pribadi.
                </li>
              </ul>
            </div>
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-1">
                🗓️ Rekap Otomatis Mingguan
              </h3>
              <p>
                Rekapitulasi tunjangan dihitung secara otomatis{" "}
                <b>setiap 7 hari</b>, dimulai dari{" "}
                <b>hari Senin hingga Minggu</b>.
              </p>
            </div>
          </div>
        </Modal>
