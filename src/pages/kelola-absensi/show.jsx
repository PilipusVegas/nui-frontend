          ...
          <table className="min-w-full border-collapse">
            ...
            <tbody>
              {dateRange.map((tgl, i) => {
                ...
                return (
                  <tr className={`text-center text-xs border-t border-b ${isSunday
      ...
      <Modal isOpen={isInfoOpen} onClose={() => setIsInfoOpen(false)} title="Informasi Halaman Presensi" note="Halaman ini menampilkan data kehadiran karyawan secara real-time dan terus diperbarui oleh sistem absensi." size="xl">
        <div className="space-y-5 text-sm text-gray-700 bg-white leading-relaxed">
          ...
          <div className="space-y-3">
            {/* Unduh Excel */}
            <div className="flex items-start gap-2 border border-gray-100 bg-gray-50 p-3 rounded-lg">
            ...
            {/* Kolom Remark */}
            <div className="flex items-start gap-4 border border-gray-100 bg-gray-50 p-3 rounded-lg">
