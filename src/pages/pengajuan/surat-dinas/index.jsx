                  ...
                  return (
                    <tr key={item.id} className="border-b hover:bg-green-50 transition">
                      ...
                      <td className="px-5 py-1 text-center space-x-3">
                        <button onClick={() => handleApprove(item)} disabled={approvingId === item.id} className={`px-4 py-1 rounded-md text-sm font-medium shadow-sm transition  ${approvingId === item.id ? "bg-gray-300 cursor-not-allowed" : "bg-green-600 hover:bg-green-700 text-white"}`}>
                          {approvingId === item.id ? (
                        ...
                        <button onClick={() => handleDetail(item)} className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-1 rounded-md text-sm font-medium shadow-sm transition">
