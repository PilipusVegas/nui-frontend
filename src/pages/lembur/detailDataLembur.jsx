    ...
    try {
      ...
      if (response.ok) {
        ...
        Swal.fire({
          icon: "success",
          title: "Berhasil!",
          text: "Anda sudah berhasil menyetujui lembur.",
        ...
        Swal.fire({
          icon: "error",
          title: "Gagal!",
          text: `Tidak dapat memperbarui status lembur: ${errorData.message}`,
          confirmButtonText: "OK",
        });
      }
    } catch (error) {
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white rounded-lg p-5 shadow-md w-[40rem] h-[20rem] max-w-full relative">
            ...
            <div className="absolute bottom-5 right-5">
              <button onClick={handleCloseModal} className="bg-blue-500 text-white py-2 px-6 rounded-md">
                Tutup
              </button>
            </div>
          </div>
